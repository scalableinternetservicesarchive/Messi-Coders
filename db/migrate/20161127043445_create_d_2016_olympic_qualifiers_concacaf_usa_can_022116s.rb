class CreateD2016OlympicQualifiersConcacafUsaCan022116s < ActiveRecord::Migration[5.0]
  def change
    create_table :d_2016_olympic_qualifiers_concacaf_usa_can_022116s do |t|
      t.string :Player
      t.string :Team
      t.float :GP
      t.float :MP
