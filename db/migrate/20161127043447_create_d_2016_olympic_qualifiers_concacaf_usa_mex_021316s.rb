class CreateD2016OlympicQualifiersConcacafUsaMex021316s < ActiveRecord::Migration[5.0]
  def change
    create_table :d_2016_olympic_qualifiers_concacaf_usa_mex_021316s do |t|
      t.string :Player
      t.string :Team
      t.float :GP
      t.float :MP
