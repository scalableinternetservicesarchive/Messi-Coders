class CreateD2016OlympicQualifiersConcacafUsaTri021916s < ActiveRecord::Migration[5.0]
  def change
    create_table :d_2016_olympic_qualifiers_concacaf_usa_tri_021916s do |t|
      t.string :Player
      t.string :Team
      t.float :GP
      t.float :MP
